...
def get_random_workout(mbti_type):
    """성격 유형에 맞는 운동을 랜덤으로 반환합니다."""
    if mbti_type in workout_dict:
        workout_list = workout_dict[mbti_type]
...
# 예시 사용
#mbti_type = 'ISTJ'
#random_workout = get_random_workout(mbti_type)
#print(f"{mbti_type} 유형의 추천 운동: {random_workout}")
